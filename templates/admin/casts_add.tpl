      ...
      <form class="form-horizontal" role="form" method="post" action="/admin/casts">
        ...
        <div class="form-group">
          <div class="col-md-12">
            <label for="intro">简介</label>
             <textarea class="form-control" placeholder="填入简介" id="intro" name="intro" rows="6"></textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="col-md-12">
            ...
            <textarea class="form-control" placeholder="输入相关资料" id="shownotes" name="shownotes" rows="6"></textarea>
          </div>
        </div>
