<div class="row">
	<div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1 round" id="about-content">
		<div id="about" class="m-t-xl m-b-xl">
			<p>Vim是一个功能强大的编辑器，熟练使用Vim，能让你的文本处理和编码效率突飞猛进。不过，Vim拥有众多的命令和使用技巧，你真的都能熟练掌握并运用吗？</p>
			<p>Vim-Tips.com 为Vimer提供来自Vim的每日技巧与点滴,让你每天都能学到来自Vim的奇技淫巧,让你的Vim更进一步...</p>
		</div>
	</div>
	<div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
		<div class="pull-right">
			<div class="col-md=12">
				<div class="row">
					<div class="col-md-6">
						<img id="avatar" src="/img/iTimothy.jpg" />
					</div>
